(function (window) {
    ...
    var drawCircleProgress = function (options) {
       ...
       // var endAngle = options.endAngle
        /*var startAngle = -Math.PI*333 / 256;*/
        var startAngle = -Math.PI*1358 / 1024;  //-130;
        /*var startAngle = -Math.PI*1348 / 1024;*/ //iphone5
        /*var startAngle = -Math.PI*1322 / 1024;*/ //iphone6plus
        /*var startAngle = -Math.PI*1312 / 1024;*/ //Google Nexus6
        var endAngle = startAngle + Math.PI * 1.63 * current / 100;
        ...
        ctx.beginPath();
        ctx.arc(x, y, r1-2, startAngle, endAngle, false);
        ctx.arc(x, y, r2+0, endAngle, startAngle, true);
        ctx.closePath();
        ctx.fillStyle = color;
        ctx.fill();
